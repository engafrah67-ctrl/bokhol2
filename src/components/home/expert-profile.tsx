...
export function ExpertProfile() {
  ...
  const AREAS = [
    t('expert_area_supplier_discovery'),
    t('expert_area_market_insights'),
    t('expert_area_product_availability'),
    t('expert_area_weekly_updates'),
    t('expert_area_buyer_supplier_conn'),
    t('expert_area_market_intel'),
  ]
