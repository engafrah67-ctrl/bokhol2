...
// Public server client for static/cached pages that do NOT require user auth cookies
...
// Authenticated server client for protected routes and user-specific data
